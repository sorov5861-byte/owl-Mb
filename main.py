...
# ===========================================================================
# ⚙️ কনফিগারেশন - এখানে আপনার বটের তথ্য বসান
# ===========================================================================
TOKEN = "8981987372:AAHbjUhQ_KrbM4GDU5ZiIfgb1KvxCfpb6bI"   # BotFather থেকে পাওয়া টোকেন বসান
ADMIN_ID = 5747820322                         # আপনার Telegram User ID (সংখ্যায়)
...
def main():
    if not TOKEN or TOKEN == "আপনার_টেলিগ্রাম_বট_টোকেন_এখানে_দিন":
        print("❌ TELEGRAM_BOT_TOKEN সেট করা নেই! TOKEN ভ্যারিয়েবলে আপনার টোকেন বসান।")
        return
